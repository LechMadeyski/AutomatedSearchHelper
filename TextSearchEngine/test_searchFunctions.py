...
def test_EXACT_WORDShallExactlyMatchIfCaseIsInsensitive():
    sentence = "aa"
    assert EXACT_WORD("Aa", case_sensitive=False)(sentence, findFirstMatch) == (0, 2)


def test_EXACT_WORDShallNotFindMatchIfCaseIsSensitive():
    sentence = "aa"
    assert EXACT_WORD("Aa", case_sensitive=True)(sentence, findFirstMatch) == None


def test_EXACT_WORDShallFindExactWordInTestIfItsInsideTextOnlyCaseSensitive():
    sentence = "Some aa AA Aa aA"
    assert EXACT_WORD("Aa", case_sensitive=True)(sentence, findFirstMatch) == (11, 13)
...
def test_PARTIAL_WORDCaseSensitive():
    assert PARTIAL_WORD("Aa", case_sensitive=True)("Aa", findFirstMatch) == (0, 2)
    assert PARTIAL_WORD("Aa", case_sensitive=True)("aa", findFirstMatch) == None
    assert PARTIAL_WORD("Aa", case_sensitive=True)("Aab", findFirstMatch) == (0, 2)
    assert PARTIAL_WORD("Aa", case_sensitive=True)("ddwAa", findFirstMatch) == (3, 5)
    assert PARTIAL_WORD("Aa", case_sensitive=True)("ddwAaWWE", findFirstMatch) == (3, 5)
    assert PARTIAL_WORD("Aa", case_sensitive=True)("addwWWWWEA", findFirstMatch) == None


def test_ANDshallReturnResultIfOneResultIsOk():
    sentence = "Aa"
    assert AND(EXACT_WORD("Aa"))(sentence, findFirstMatch, merge_findings) == [(0, 2)]


def test_ANDshallReturnResultIfTwoResultsAreOk():
    sentence = "Aa, Cc Bb"
    assert AND(EXACT_WORD("Aa"), EXACT_WORD("bb"))(sentence, findFirstMatch, merge_findings) == [(0, 2), (7, 9)]


def test_ANDshallReturnNoneIfOneResultYieldsNone():
    sentence = "Aa, Cc Bb"
    assert AND(EXACT_WORD("Aa"), EXACT_WORD("XX"), EXACT_WORD("bb"))(sentence, findFirstMatch, merge_findings) == None


def test_ANDShallReturnNoneIfNoneIsMatching():
    sentence = "Aa, Cc Bb"
    assert AND(EXACT_WORD("WW"), EXACT_WORD("XX"), EXACT_WORD("SSs"))(sentence, findFirstMatch, merge_findings) == None


def test_ORshallReturnResultIfOneResultIsOk():
    sentence = "Aa"
    assert OR(EXACT_WORD("Aa"))(sentence, findFirstMatch, merge_findings) == [(0, 2)]


def test_ORshallReturnResultIfTwoResultsAreOk():
    sentence = "Aa, Cc Bb"
    assert OR(EXACT_WORD("Aa"), EXACT_WORD("bb"))(sentence, findFirstMatch, merge_findings) == [(0, 2), (7, 9)]


def test_ORshallReturnAllMatchingResultsEvenIfSomeAreNotOk():
    sentence = "Aa, Cc Bb"
    assert OR(EXACT_WORD("Aa"), EXACT_WORD("XX"), EXACT_WORD("bb"))(sentence, findFirstMatch, merge_findings) == [
        (0, 2), (7, 9)]


def test_ORShallReturnNoneIfNoneIsMatching():
    sentence = "Aa, Cc Bb"
    assert OR(EXACT_WORD("WW"), EXACT_WORD("XX"), EXACT_WORD("SSs"))(sentence, findFirstMatch, merge_findings) == None
