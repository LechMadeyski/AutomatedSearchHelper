...
def test_mergeResultShouldReturnSameResultIfOneIsGiven():
    ...
    assert merge_results([exampleJson]) == exampleJson
...
def test_properlyMergeDifferentSections():
    ...
    assert merge_results([deepcopy(res1), deepcopy(res2)]) == expectedResult
...
def test_properlyMergeDifferentParagraphsInTheSameSection():
    ...
    expectedResult[1]["paragraphs"] = [deepcopy(res2[1]["paragraphs"][0]), deepcopy(res1[0]["paragraphs"][0]),
                                       deepcopy(res2[1]["paragraphs"][1])]

    assert merge_results([res1, res2]) == expectedResult
